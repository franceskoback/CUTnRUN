...
trimmomatic_path_jar	=	"/Users/fkoback/software/Trimmomatic-0.39/trimmomatic-0.39.jar"
adapter_path			=	"/opt/anaconda3/envs/CUTnRUN/opt/bbmap-38.18/resources/adapters.fa"
kseq_path_exec			=	"/Users/fkoback/software/kseq/kseq_test"
bwa_path_exec			=	"/Users/fkoback/software/bwa/bwa"
bwa_hg_masked_index		=	"mm10" # need to put all the bwa index files in the working directory!! Or bwa aln will not run!! because you did bwa index -p mm10, this needs to be "mm10" here
bwa_sc_masked_index		=	"<path>/sacCer_bwa_index"
stampy_hg_stidx_hash	=	"mm10" # make sure you're in the right folder too 
stampy_sc_stidx_hash	=	"<path>/sacCer_bwa_index"
samtools_path_exec		=	"/Users/fkoback/software/samtools-1.15"
picard_path_jar			=	"/Users/fkoback/software/picard-2.26.11/picard.jar"
stampy_path= "/Users/fkoback/software/stampy-1.0.32/stampy.py"
...
output_command = "" +kseq_path_exec+ " " +trim_folder+ "" +sample_id+ "_1.paired_trimmomatic.fastq.gz " +str(read_length)+ " " +trim_folder+ "" +sample_id+ "_1.paired_kseqTrimmed.fastq.gz 2> " +logs_folder+ "" +sample_id+ "_kseqTrim_r1.err"
output_script.write(output_command)
output_script.write("\n")

# $kseqbin/kseq_test $trimdir/"$base"_2.paired.fastq.gz $len $trimdir2/"$base"_2.paired.fastq.gz
output_command = "" +kseq_path_exec+ " " +trim_folder+ "" +sample_id+ "_2.paired_trimmomatic.fastq.gz " +str(read_length)+ " " +trim_folder+ "" +sample_id+ "_2.paired_kseqTrimmed.fastq.gz 2> " +logs_folder+ "" +sample_id+ "_kseqTrim_r2.err"
output_script.write(output_command)
output_script.write("\n\n")
...
output_command = stampy_path+" -g " +stampy_hg_stidx_hash+ " -h " +stampy_hg_stidx_hash+ " -t " +num_cores+ " --sensitive -M " +aligned_folder+ "/" +sample_id+ "_hgAligned.bam | samtools view -Sb - > " +aligned_folder+ "/" +sample_id+ "_hgAligned_stampyFiltered.bam 2> " +logs_folder+ "" +sample_id+ "_stampy_hg.err"
output_script.write(output_command)
output_script.write("\n\n")
...
# ./stampy.py -g hg18 -h hg18 -t 8 --bamkeepgoodreads -M bwa.bam 
output_command = stampy_path + " -g " +stampy_sc_stidx_hash+ " -h " +stampy_sc_stidx_hash+ " -t " +num_cores+ " --sensitive -M " +aligned_folder+ "/" +sample_id+ "_scAligned.bam | samtools view -Sb - > " +aligned_folder+ "/" +sample_id+ "_scAligned_stampyFiltered.bam 2> " +logs_folder+ "" +sample_id+ "_stampy_sc.err"
output_script.write(output_command)
output_script.write("\n\n")
